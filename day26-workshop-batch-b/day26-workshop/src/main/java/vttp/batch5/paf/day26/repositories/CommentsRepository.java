...
public class CommentsRepository {
    ...
    public List<JsonObject> getCommentsByGid(int gid){
        Criteria criteria = Criteria.where(F_GID).is(gid); //specify the game's unique id
        ...
        return template.find(query,Document.class, C_COMMENTS) //returns a list/array of documents
            .stream() //map each document(record) into a json object
            .map(doc -> 
